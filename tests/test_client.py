...
from meorphis_test_6 import MeorphisTest6, AsyncMeorphisTest6, APIResponseValidationError
from meorphis_test_6._client import MeorphisTest6, AsyncMeorphisTest6
from meorphis_test_6._models import BaseModel, FinalRequestOptions
from meorphis_test_6._constants import RAW_RESPONSE_HEADER
from meorphis_test_6._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from meorphis_test_6._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: MeorphisTest6 | AsyncMeorphisTest6) -> int:
...
class TestMeorphisTest6:
    client = MeorphisTest6(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "meorphis_test_6/_legacy_response.py",
                        "meorphis_test_6/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "meorphis_test_6/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: MeorphisTest6) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(MEORPHIS_TEST_6_BASE_URL="http://localhost:5000/from/env"):
            client = MeorphisTest6(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(MEORPHIS_TEST_6_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                MeorphisTest6(api_key=api_key, _strict_response_validation=True, environment="production")
    ...
    def test_base_url_trailing_slash(self, client: MeorphisTest6) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: MeorphisTest6) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: MeorphisTest6) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = MeorphisTest6(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = MeorphisTest6(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("meorphis_test_6._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
...
class TestAsyncMeorphisTest6:
    client = AsyncMeorphisTest6(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMeorphisTest6) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MEORPHIS_TEST_6_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMeorphisTest6(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(MEORPHIS_TEST_6_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                AsyncMeorphisTest6(api_key=api_key, _strict_response_validation=True, environment="production")
    ...
    def test_base_url_trailing_slash(self, client: AsyncMeorphisTest6) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMeorphisTest6) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMeorphisTest6) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMeorphisTest6(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncMeorphisTest6(base_url=base_url, api_key=api_key, _strict_response_validation=False)
